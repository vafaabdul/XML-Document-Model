...
* --------------------
* ver 1.7 :20 Mar 15
* - Added getTag() and getChildren methods to all the classes
* ver 1.6 :18 Mar 15
* - Comleted methods of ProcInstrElement and ComentElement
* ver 1.5 : 22 Feb 15
...
namespace XmlProcessing
{
  ...
  public:
	...
	virtual std::vector<std::shared_ptr<AbstractXmlElement>> getChildren(){
		...
		return vec;};
	virtual std::vector<std::pair<std::string, std::string>> getAttrib(){ std::vector<std::pair<std::string, std::string>> vec;
	return vec;
	}
  ...
  public:
    ...
    virtual std::string value();
    virtual std::string toString();
	virtual std::string getTag(){ return tag_; };
	virtual std::vector<std::pair<std::string, std::string>> getAttrib(){ return attribs_; };
  private:
    std::string tag_;
    std::vector<std::shared_ptr<AbstractXmlElement>> children_;
